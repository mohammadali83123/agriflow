...
import { recordPurchase } from "@/server/inventory/actions";
          ...
          <div className="space-y-5">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                {warehouses.length === 0 && (
                  <p className="text-xs text-destructive">
                    No warehouses found. Create one first in{" "}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setValue("quantity", isNaN(val) ? (undefined as unknown as number) : val);
                }}
        ...
        <div className="px-6 py-6 border-b">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="reason"
                placeholder="e.g. Lot #123, received at gate 2"
                rows={2}
                {...register("reason")}
              />
            </div>
