...
CREATE TYPE "public"."inventory_transaction_type" AS ENUM('purchase', 'production_in', 'production_out', 'sale', 'reserve', 'release', 'dispatch', 'transfer_in', 'transfer_out', 'adjustment', 'opening');--> statement-breakpoint
...
ALTER TABLE "inventory_transaction" ADD CONSTRAINT "inventory_transaction_org_id_organization_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventory_transaction" ADD CONSTRAINT "inventory_transaction_product_id_product_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."product"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "warehouse" ADD CONSTRAINT "warehouse_org_id_organization_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "warehouse" ADD CONSTRAINT "warehouse_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;